...
export class ComboBox extends UIComponent {
    ...
    */
    ...
    protected changeList(): void {
        ...
        this._list.realItemRender = this.itemRender || { type: "Box", child: [{ type: "Label", props: { name: "label", x: 1, padding: _padding, width: labelWidth, height: this._itemHeight, fontSize: this._itemSize, color: labelColor } }] };
